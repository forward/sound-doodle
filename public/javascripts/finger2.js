...
var SAMPLING_FREQUENCY = 10;
var PLAYBACK_FREQUENCY = 50;
...
var Sound = {
  ...
  play: function(file, startTime, timeSpan, totalTime) {
    ...
    //  x     = 100 / 30 
    var speed =  timeSpan / PLAYBACK_FREQUENCY * 0.5
    console.log("SPEEED:: " + timeSpan / PLAYBACK_FREQUENCY + " == " + speed);
...
Shape.prototype.playSound = function() {
  if(this.canPlaySound) {
    ...
    console.log(interestingSegment.counter);
...
Shape.prototype.markProjection = function(segment, point) {
  ...
  console.log(this.markedSegmentCounter);
  console.log(segment.counter);
  console.log('-----');
